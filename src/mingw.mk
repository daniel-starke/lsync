...
CFLAGS = -O2 -DNDEBUG -D__USE_MINGW_ANSI_STDIO=0 -mtune=core2 -march=core2 -mstackrealign -flto -ffat-lto-objects -fomit-frame-pointer -fno-ident -fgraphite -municode
LDFLAGS = -s -static -fno-ident -municode -fwhole-program
